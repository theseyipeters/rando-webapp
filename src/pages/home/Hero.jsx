...
export default function Hero() {
	return (
		<div className="w-full px-[20px] md:px-[50px] lg:px-[90px] xl:px-[120px] pt-[220px] pb-[220px] lg:pb-0">
			<div className="w-full md:w-[80%] lg:w-[80%] xl:w-[60%] flex flex-col gap-[20px] text-white-1 text-sm md:text-base lg:text-base xl:text-lg">
				<h1 className="text-[40px] md:text-6xl flex leading-normal font-medium tracking-[-1.28px}">
